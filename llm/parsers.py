...
- muscle_mass_kg：取「去脂体重」（即「总肌肉量」，单位kg，通常55-70kg，是体重减去脂肪的较大数值，不是「骨骼肌量」）
- muscle_rate_pct：取「肌肉率」（通常65-70%）
- skeletal_muscle_kg：取「骨骼肌量」（单位kg，通常30-40kg，远小于去脂体重）
...
返回格式：
{
  ...
  "body_fat_pct": 数字,
  "body_fat_kg": 数字,
  "muscle_mass_kg": 数字（取「去脂体重」/「总肌肉量」，较大的数，55-70kg范围）,
  "muscle_rate_pct": 数字,
  "skeletal_muscle_kg": 数字（取「骨骼肌量」，30-40kg范围，远小于去脂体重）,
  "skeletal_muscle_rate_pct": 数字,
  "fat_free_mass_kg": 数字（同上，去脂体重，与muscle_mass_kg取同一个字段）,
  "protein_kg": 数字,
  "water_kg": 数字,
  "bone_mass_kg": 数字,
